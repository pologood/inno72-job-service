package com.inno72.job.executer.example;
...
public class Inno72Application extends SpringBootServletInitializer
{
	public static void main(String[] args) {
		new SpringApplicationBuilder(Inno72Application.class, "inno72-job-executor-ex-service", args);
	}

	@Override
	public String setAppNameForLog() {
		return "inno72-job-executor-ex-service";
	}
}
